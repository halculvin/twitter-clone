...
import { HiChartBar, HiDotsHorizontal, HiOutlineSwitchHorizontal } from 'react-icons/hi'
import Moment from 'react-moment';
import { useRecoilState } from 'recoil';
import { modalState, postIdState } from '@/atoms/modalAtom';
import { useRouter } from 'next/router';

const Post:FunctionComponent<{id:string, post:any, postPage?:any}> = ({id, post, postPage}) => {
